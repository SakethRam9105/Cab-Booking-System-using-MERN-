...
const AcarCard = ({ car, handleDelete }) => {
        ...
        <div className="card car-card" key={car._id} id='pop' style={{ width: '18rem', backgroundColor: '#343a40', color: '#ffffff', border: 'none' }}>
            ...
            <div className="card-body">
                ...
                <div className='text-right'>
                    <button className="btn" style={{ backgroundColor: "rgb(0,123,255)", color: "white", border: "none"}} onClick={handleDeleteClick}>
                        Delete
                    </button>
                </div>
            </div>
